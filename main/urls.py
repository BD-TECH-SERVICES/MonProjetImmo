...
urlpatterns = [
    ...
    path('primo-accedant', views.primo_accedant, name='primo_accedant'),
    path('notre-mission', views.notre_mission, name='notre_mission'),
    path('nos-partenaires', views.nos_partenaires, name='nos_partenaires'),
